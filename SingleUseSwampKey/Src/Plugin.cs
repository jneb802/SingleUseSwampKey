...
namespace SingleUseSwampKey
{
    ...
    public class SingleUseSwampKeyPlugin : BaseUnityPlugin
    {
        internal const string ModName = "SingleUseSwampKey";
        ...
        public static readonly ManualLogSource
            SingleUseSwampKeyLogger = BepInEx.Logging.Logger.CreateLogSource(ModName);
        ...
        private void ReadConfigValues(object sender, FileSystemEventArgs e)
        {
            ...
            try
            {
                SingleUseSwampKeyLogger.LogDebug("ReadConfigValues called");
                Config.Reload();
            }
            catch
            {
                SingleUseSwampKeyLogger.LogError($"There was an issue loading your {ConfigFileName}");
                SingleUseSwampKeyLogger.LogError("Please check your config entries for spelling and format!");
            }
        }
